...
# Hauptseiten-Link in der Sidebar ausblenden
st.markdown(
    """<style>
...
# --- Hauptseite deaktiviert – nur Seitennavigation ---
st.title("💊 Lavita Wettbewerbs-Monitor")
st.info("👈 Nutze die **Seitenleiste** um zwischen den Analyse-Seiten zu wechseln: Produkt-Ranking, Trends, Marktanalyse, BSR-Kategorien, Produkt-Suche.")

# --- AUSKOMMENTIERT: KPI-Dashboard (bei Bedarf wieder aktivieren) ---
# df = get_data()
...
#
# st.markdown("---")
# st.info("👈 Nutze die **Seitenleiste** um zwischen den Analyse-Seiten zu wechseln.")